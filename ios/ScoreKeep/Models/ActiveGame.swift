...
struct ActiveGame: Codable {
    ...
    /// Global ordered action log — drives cross-team undo for football/basketball.
    ...
    init(from decoder: Decoder) throws {
        ...
        globalActionLog   = (try? c.decode([ScoredAction].self, forKey: .globalActionLog)) ?? []
    ...
    init(
        ...
        self.globalActionLog  = globalActionLog
        self.sets             = sets
